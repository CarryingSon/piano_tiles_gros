-- Začasni Kokosy test uporablja ročno odigrani delni beatmap do 131,77 s.
-- Zadnjih 97,60 s namenoma nima not; ta migracija samo uskladi strežniško
-- validacijo rezultata s trenutno testno karto v `src/data/charts.ts`.
