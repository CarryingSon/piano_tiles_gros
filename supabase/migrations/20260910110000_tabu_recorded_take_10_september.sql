-- Tabu: nov posneti chart z dne 10. 9. 2026, po istem postopku kot Kokosy uro
-- prej — steze tipkane po eni naenkrat, vsaka nota v stezo, ki jo je izbral
-- prst. Not je 586 (25 holdov) namesto 460 (56 holdov).
--
-- Iz posnetka je popravljenih devet holdov, vsi po istem pravilu: hold je bil
-- daljsi od razmika do naslednje note, zato je skrajsan natanko do nje. Skupaj
-- gre za 0,89 s cez cel komad. Nobena nota ni dodana ali odvzeta.
--
-- Strop se premakne z njim:
--
--   mrfy    228890  (387 not)
--   kokosy  211250  (451 not)
--   tabu    283570  (586 not)   <- spremenjeno, prej 260300 / 460
--
-- Zadnja nota pade pri 234,73 s, komad pa traja 241,75 s: zadnjih 7 s je brez
-- ploscic. Tako je zaigrano in tako ostane.
--
-- Krogi Tabuja po starem chartu padejo: strop je bil drugacen, zato v skupnem
-- sestevku ne bi bili primerljivi.
...
-- Kokosy in MRFY se ne dotaknemo: njuna chart in strop ostajata taka, kot sta.
DELETE FROM public.leaderboard_sessions WHERE song_id = 'tabu';
