...
export const editions: Edition[] = [
  {
    ...
    performers: [
      ...
      "Babooni",
      "Koala Voice",
      "Tommy and the Easy Peasies",
    ],
    note: "Ideja, rojena po 20. obletnici kluba, je prvič oživela pred Gasilskim centrom Grosuplje.",
    /* Po ena fotografija na zasedbo, v istem vrstnem redu kot so naštete. */
    images: [
      {
        src: "/media/2022/joker-out-na-odru-2022.jpg",
        alt: "Zasedba na odru pred polnim šotorom ob koncu nastopa na Glasbenem Atlasu 2022.",
        width: 1600,
        height: 1067,
        caption: "Joker Out · Glasbeni Atlas 2022",
      },
      {
        src: "/media/2022/priklon-benda-2022.jpg",
        alt: "Peterica glasbenikov s kitarami in objemi na odru Glasbenega Atlasa 2022.",
        width: 1600,
        height: 1067,
        caption: "Babooni · Glasbeni Atlas 2022",
      },
      {
        src: "/media/2022/koala-voice-na-odru-2022.jpg",
        alt: "Pevka s kitaro v rdeči odrski svetlobi na Glasbenem Atlasu 2022.",
        width: 1600,
        height: 1067,
        caption: "Koala Voice · Glasbeni Atlas 2022",
      },
      {
        src: "/media/2022/tommy-and-the-easy-peasies-2022.jpg",
        alt: "Pevec s kitaro pred mikrofonom med nastopom na Glasbenem Atlasu 2022, črno-bel posnetek.",
        width: 1600,
        height: 1067,
        caption: "Tommy and the Easy Peasies · Glasbeni Atlas 2022",
      },
    ],
  },
  {
